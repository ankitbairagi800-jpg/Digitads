-- Seeding Script
INSERT INTO blogs (id, title, excerpt, content, category, readTime, date, tags, slug, icon, isFeatured) VALUES (
  'ai-future-marketing',
  'The Future of Marketing: How AI is Changing the Game in 2025',
  'Artificial intelligence isn''t just a buzzword—it''s actively reshaping how businesses acquire and retain customers. In this deep dive, we explore practical AI applications you can implement today.',
  '# The Future of Marketing: How AI is Changing the Game in 2025
...
INSERT INTO blogs (id, title, excerpt, content, category, readTime, date, tags, slug, icon, isFeatured) VALUES (
  'ai-local-seo',
  'How AI is Revolutionizing Local SEO for Clinics',
  'Discover how artificial intelligence tools can automate your GMB optimization and bring consistent local leads.',
  '# How AI is Revolutionizing Local SEO for Clinics
...
INSERT INTO blogs (id, title, excerpt, content, category, readTime, date, tags, slug, icon, isFeatured) VALUES (
  'meta-vs-google',
  'Meta Ads vs Google Ads: Which is Better for Coaching Centers?',
  'A comprehensive breakdown of when to use Meta Ads for awareness and Google Ads student enrollments.',
  '# Meta Ads vs Google Ads: Which is Better for Coaching Centers?
...
INSERT INTO blogs (id, title, excerpt, content, category, readTime, date, tags, slug, icon, isFeatured) VALUES (
  'whatsapp-automation',
  'The Ultimate Guide to WhatsApp Marketing Automation',
  'Learn how to set up an automated WhatsApp funnel that nurtures leads and schedules appointments 24/7.',
  '# The Ultimate Guide to WhatsApp Marketing Automation
...
- **The Result:** Reduce no-show rates by up to 80% for clinics and spas.',
  ...
  '6 min read',
  'Jul 28, 2024',
  'WhatsApp,Chatbot,Lead Nurturing',
  'whatsapp-automation',
...
INSERT INTO blogs (id, title, excerpt, content, category, readTime, date, tags, slug, icon, isFeatured) VALUES (
  ...
  'Why Your Clinic Needs a Dedicated Landing Page',
  'Stop sending ad traffic to your homepage. Here is why dedicated landing pages convert 3x better for healthcare.',
  '# Why Your Clinic Needs a Dedicated Landing Page
...
Google rewards landing pages that match the ad''s keyword exactly. A higher match rating improves your **Quality Score**, which directly lowers your cost-per-click (CPC) by up to 30%!',
  ...
  '4 min read',
  'Jul 10, 2024',
  'Web Design,CRO,Clinics',
  'clinic-landing-pages',
  'fa-solid fa-laptop-medical',
  0
) ON CONFLICT(id) DO UPDATE SET title=excluded.title, excerpt=excluded.excerpt, content=excluded.content, category=excluded.category, readTime=excluded.readTime, date=excluded.date, tags=excluded.tags, slug=excluded.slug, icon=excluded.icon, isFeatured=excluded.isFeatured;

INSERT INTO services (id, title, price, description, features, icon, visualTitle, visualDescription, reverseLayout, "order") VALUES (
  'meta-ads',
  'Meta Ads — Facebook & Instagram Advertising',
  '₹12,000/month',
  'We design and manage high-converting Meta Ad campaigns that target your ideal patients or students with surgical precision — not just broad demographics. From creative to conversion, we handle everything.',
  'Campaign strategy and audience research,Professional ad creative design (static + video),Facebook & Instagram campaign setup,Lookalike & retargeting audiences,Lead form and landing page integration,Daily monitoring & weekly optimization,Monthly performance reports with insights',
  'fab fa-meta',
  'Meta Ads Indore',
  'Facebook & Instagram campaigns that generate 5–15 qualified leads daily for clinics and coaching centers',
  0,
  1
...
INSERT INTO services (id, title, price, description, features, icon, visualTitle, visualDescription, reverseLayout, "order") VALUES (
  'google-ads',
  'Google Ads — Search & YouTube Campaigns',
  '₹12,000/month',
  'When someone in Indore searches "best skin clinic near me" or "NEET coaching in Indore" — your ad appears first. We capture high-intent traffic that converts into appointments faster than any other channel.',
  'Keyword research and competitor analysis,Google Search campaign setup and optimization,YouTube ad campaigns (in-stream & shorts),Display and remarketing campaigns,Conversion tracking with Google Analytics 4,Smart bidding and Quality Score optimization,Monthly detailed performance dashboard',
  'fab fa-google',
  'Google Ads Indore',
  'Capture high-intent searches and turn them into booked appointments within 30 days',
  1,
  2
) ON CONFLICT(id) DO UPDATE SET title=excluded.title, price=excluded.price, description=excluded.description, features=excluded.features, icon=excluded.icon, visualTitle=excluded.visualTitle, visualDescription=excluded.visualDescription, reverseLayout=excluded.reverseLayout, "order"=excluded."order";
...
INSERT INTO services (id, title, price, description, features, icon, visualTitle, visualDescription, reverseLayout, "order") VALUES (
  'gmb-seo',
  'GMB Optimization & Local SEO Indore',
  '₹8,000/month',
  'When locals search for services in Indore, they see the Google Maps "Local Pack" first. We get your business into that coveted top 3 — more walk-ins, more calls, more business from people already searching for what you offer.',
  'Complete GMB profile audit and optimization,Google Maps ranking strategy,Review generation and reputation management,Local keyword optimization (Indore + MP),Citation building and directory listings,On-page local SEO for your website,Monthly ranking progress reports',
  'fas fa-map-marked-alt',
  'GMB & Local SEO Indore',
  'Rank in Google Maps Top 3 and attract 50–200% more walk-ins from local searches',
  0,
  3
) ON CONFLICT(id) DO UPDATE SET title=excluded.title, price=excluded.price, description=excluded.description, features=excluded.features, icon=excluded.icon, visualTitle=excluded.visualTitle, visualDescription=excluded.visualDescription, reverseLayout=excluded.reverseLayout, "order"=excluded."order";
...
INSERT INTO services (id, title, price, description, features, icon, visualTitle, visualDescription, reverseLayout, "order") VALUES (
  'ai-video',
  'AI Video Ads — Reels & YouTube Shorts',
  '₹10,000/month (4 videos)',
  'Video content is king — but expensive to produce. We use AI tools like CapCut AI, ElevenLabs, and ChatGPT to create professional, scroll-stopping video ads at a fraction of traditional production costs.',
  'AI-generated scripts and voiceovers (ElevenLabs),Professional Reel editing with CapCut AI,Auto-subtitles transitions and motion graphics,Brand-consistent styling and colors,Optimized for Instagram Reels and YouTube Shorts,4–8 videos per month depending on plan,Ready-to-publish with posting schedule',
  'fas fa-film',
  'AI Video Ads Indore',
  'Professional Reels & Shorts that build trust and drive action — without expensive production crews',
  1,
  4
) ON CONFLICT(id) DO UPDATE SET title=excluded.title, price=excluded.price, description=excluded.description, features=excluded.features, icon=excluded.icon, visualTitle=excluded.visualTitle, visualDescription=excluded.visualDescription, reverseLayout=excluded.reverseLayout, "order"=excluded."order";
...
INSERT INTO services (id, title, price, description, features, icon, visualTitle, visualDescription, reverseLayout, "order") VALUES (
  ...
  'One-time setup ₹15,000 – ₹40,000',
  'Most businesses lose 60–70% of leads because they follow up too late or not at all. We build automated workflows using n8n and Make.com that respond instantly — 24/7 — turning cold inquiries into booked appointments.',
  'Instant WhatsApp auto-reply to new leads,Appointment booking reminder flows,Email and SMS drip sequences,CRM lead tracking and pipeline setup,n8n / Make.com workflow automation,Integration with Facebook Lead Ads & Google Forms,No lead left behind — 100% follow-up guarantee',
  'fab fa-whatsapp',
  'WhatsApp Automation Indore',
  'Never lose a lead again — 24/7 automated follow-up that converts inquiries to appointments',
  0,
  5
) ON CONFLICT(id) DO UPDATE SET title=excluded.title, price=excluded.price, description=excluded.description, features=excluded.features, icon=excluded.icon, visualTitle=excluded.visualTitle, visualDescription=excluded.visualDescription, reverseLayout=excluded.reverseLayout, "order"=excluded."order";
...
INSERT INTO services (id, title, price, description, features, icon, visualTitle, visualDescription, reverseLayout, "order") VALUES (
  ...
  'Starting from ₹8,000 (one-time)',
  'Your ad campaign is only as good as the page people land on. We build fast, mobile-optimized, conversion-focused landing pages that turn ad clicks into real inquiries — not bounces.',
  'Mobile-first fully responsive design,Conversion-optimized layout and copywriting,Fast Core Web Vitals and page speed,WhatsApp click-to-chat integration,Lead form with CRM/WhatsApp automation,SEO-ready structure and meta tags,A/B testing support',
  'fas fa-laptop-code',
  'Landing Pages Indore',
  'Pages that load fast, look premium, and convert visitors into leads — not just pretty designs',
  1,
  6
) ON CONFLICT(id) DO UPDATE SET title=excluded.title, price=excluded.price, description=excluded.description, features=excluded.features, icon=excluded.icon, visualTitle=excluded.visualTitle, visualDescription=excluded.visualDescription, reverseLayout=excluded.reverseLayout, "order"=excluded."order";
...
INSERT INTO services (id, title, price, description, features, icon, visualTitle, visualDescription, reverseLayout, "order") VALUES (
  ...
  'Logo from ₹5,000 | Full Branding from ₹15,000',
  'Your brand is the first impression. We create professional logo designs and complete brand identity systems that build instant trust and make your clinic or coaching center look like the premium choice in Indore.',
  'Custom logo design (3 concepts),Brand color palette and typography,Social media profile branding,Business card and letterhead design,Brand style guide document,All files in editable formats (AI PNG SVG)',
  'fas fa-paint-brush',
  'Logo & Branding Indore',
  'Professional brand identity that builds trust and makes you the obvious choice in your market',
  0,
  7
) ON CONFLICT(id) DO UPDATE SET title=excluded.title, price=excluded.price, description=excluded.description, features=excluded.features, icon=excluded.icon, visualTitle=excluded.visualTitle, visualDescription=excluded.visualDescription, reverseLayout=excluded.reverseLayout, "order"=excluded."order";
